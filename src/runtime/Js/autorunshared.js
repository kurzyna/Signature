...
function display_insight_infobar() {
  Office.context.mailbox.item.notificationMessages.addAsync("fd90eb33431b46f58a68720c36154b4a", {
    type: "insightMessage",
    message: "Ustaw swoją stopkę za pomocą dodatku AK Signature.",
    icon: "Icon.16x16",
    actions: [
      {
...
.MsoChpDefault
	...
	mso-bidi-font-size:12.0pt;
	mso-ascii-font-family:Poppins;
	mso-fareast-font-family:Aptos;
	mso-fareast-theme-font:minor-latin;
	mso-hansi-font-family:Poppins;
	mso-bidi-font-family:"Times New Roman";
	mso-bidi-theme-font:minor-bidi;
 ...
 /* Page Definitions */
 @page
	{mso-footnote-separator:url("site_full_pliki/header.htm") fs;
	mso-footnote-continuation-separator:url("site_full_pliki/header.htm") fcs;
	mso-endnote-separator:url("site_full_pliki/header.htm") es;
	mso-endnote-continuation-separator:url("site_full_pliki/header.htm") ecs;}
@page WordSection1
	{size:595.3pt 841.9pt;
	margin:70.85pt 70.85pt 70.85pt 70.85pt;
	mso-header-margin:35.4pt;
	mso-footer-margin:35.4pt;
	mso-even-footer:url("site_full_pliki/header.htm") ef1;
	mso-footer:url("site_full_pliki/header.htm") f1;
	mso-first-footer:url("site_full_pliki/header.htm") ff1;
	mso-paper-source:0;}
div.WordSection1
	{page:WordSection1;}
-->
...
<body lang=PL link="#467886" vlink="#96607D" style='tab-interval:35.4pt;
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:1'>
  <td width=435 style='width:326.0pt;padding:0cm 0cm 0cm 0cm'>
  <p class=MsoNormal style='margin-bottom:0cm;line-height:normal'><b><span
  style='font-size:14.0pt'>${user_info.name}</span></b><b><span
 ...
 <tr style='mso-yfti-irow:2'>
  ...
  style='font-size:8.0pt;mso-bidi-font-size:9.0pt'>${user_info.job}<o:p></o:p></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:3'>
  <td width=435 style='width:326.0pt;padding:0cm 0cm 0cm 0cm'>
  <p class=MsoNormal style='margin-bottom:0cm;line-height:normal'><span
  style='font-size:8.0pt;mso-bidi-font-size:9.0pt'>${user_info.team}<o:p></o:p></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:4'>
  <td width=435 style='width:326.0pt;padding:0cm 0cm 0cm 0cm'>
  <p class=MsoNormal style='margin-bottom:12.0pt;line-height:normal'><span
  style='font-size:8.0pt;mso-bidi-font-size:9.0pt'>${user_info.department}<o:p></o:p></span></p>
  </td>
 </tr>
<tr style='mso-yfti-irow:5'>
  <td width=435 style='width:326.0pt;padding:0cm 0cm 0cm 0cm'>
    <p class=MsoNormal style='margin-top:0pt;margin-right:0cm;margin-bottom:0cm;margin-left:0cm;line-height:normal'>
      <a href="tel:${user_info.phone}" style="text-decoration: none; color: black;">
        <b><span style='font-size:12.0pt;'>${user_info.phone}</span></b>
      </a>
    </p>
  </td>
</tr>
<tr style='mso-yfti-irow:6'>
  <td width=435 style='width:326.0pt;padding:0cm 0cm 0cm 0cm'>
    <p class=MsoNormal style='margin-bottom:12.0pt;line-height:normal'>
      <a href="mailto:${user_info.email}" style="text-decoration: none; color: black;">
        <b><span style="font-size:12.0pt;">${user_info.email}</span></b>
      </a>
    </p>
  </td>
</tr>
